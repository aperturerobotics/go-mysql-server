...
func ColumnReferencedInDefaultValueExpression(ctx *sql.Context, generated *sql.ColumnDefaultValue, colName string) bool {
	...
	var found bool
	sql.Inspect(ctx, generated, func(ctx *sql.Context, e sql.Expression) bool {
...
func (d *DropColumn) Validate(ctx *sql.Context, tbl sql.Table) error {
	...
	for _, col := range d.targetSchema {
		if col.HiddenSystem && col.Generated != nil && ColumnReferencedInDefaultValueExpression(ctx, col.Generated, colLower) {
