...
var systemVars = map[string]sql.SystemVariable{
	...
	// SQL_MODE values pulled from MySQL source code:
	//  https://github.com/mysql/mysql-server/blob/23e360a7fac718d80b9e6a79f7d5a7bf37aa3bbc/sql/sys_vars.cc#L4784
	"sql_mode": &sql.MysqlSystemVariable{
		Name:              "sql_mode",
		Scope:             sql.GetMysqlScope(sql.SystemVariableScope_Both),
		Dynamic:           true,
		SetVarHintApplies: true,
		Type: types.NewSystemSetType(
			"sql_mode",
			sql.Collation_utf8mb4_0900_ai_ci,
			"REAL_AS_FLOAT",
			"PIPES_AS_CONCAT",
			"ANSI_QUOTES",
			"IGNORE_SPACE",
			...
			"NO_DIR_IN_CREATE",
			"NO_AUTO_CREATE_USER", // TODO: this is deprecated, have it take up NOT_USED_9 for now
			//"NOT_USED_9",
			"NOT_USED_10",
			"NOT_USED_11",
			"NOT_USED_12",
