...
var BuiltIns = []sql.Function{
	...
	sql.FunctionN{Name: "atan2", Fn: NewAtan},
	...
	sql.Function1{Name: "bit_and", Fn: func(ctx *sql.Context, e sql.Expression) sql.Expression { return aggregation.NewBitAnd(e) }},
	sql.Function1{Name: "bit_count", Fn: NewBitCount},
	sql.Function1{Name: "bit_length", Fn: NewBitlength},
	sql.Function1{Name: "bit_or", Fn: func(ctx *sql.Context, e sql.Expression) sql.Expression { return aggregation.NewBitOr(e) }},
	sql.Function1{Name: "bit_xor", Fn: func(ctx *sql.Context, e sql.Expression) sql.Expression { return aggregation.NewBitXor(e) }},
	sql.Function1{Name: "ceil", Fn: NewCeil},
	sql.Function1{Name: "ceiling", Fn: NewCeil},
	sql.FunctionN{Name: "char", Fn: NewChar},
	sql.Function1{Name: "charset", Fn: NewCharset},
	...
	sql.Function1{Name: "compress", Fn: NewCompress},
	...
	sql.Function1{Name: "first", Fn: func(ctx *sql.Context, e sql.Expression) sql.Expression { return aggregation.NewFirst(e) }},
	...
	sql.Function1{Name: "json_arrayagg", Fn: func(ctx *sql.Context, e sql.Expression) sql.Expression { return aggregation.NewJsonArray(e) }},
	...
	sql.FunctionN{Name: "lag", Fn: func(ctx *sql.Context, e ...sql.Expression) (sql.Expression, error) { return window.NewLag(e...) }},
	sql.Function1{Name: "last", Fn: func(ctx *sql.Context, e sql.Expression) sql.Expression { return aggregation.NewLast(e) }},
	...
	sql.FunctionN{Name: "lead", Fn: func(ctx *sql.Context, e ...sql.Expression) (sql.Expression, error) { return window.NewLead(e...) }},
	...
	sql.Function2{Name: "st_disjoint", Fn: spatial.NewDisjoint},
	...
	sql.Function1{Name: "st_exteriorring", Fn: spatial.NewExteriorRing},
	...
	sql.Function2{Name: "st_geometryn", Fn: spatial.NewGeometryN},
	sql.Function1{Name: "st_geometrytype", Fn: spatial.NewGeometryType},
	sql.FunctionN{Name: "st_geohash", Fn: spatial.NewGeoHash},
	...
	sql.Function2{Name: "st_interiorringn", Fn: spatial.NewInteriorRingN},
	...
	sql.FunctionN{Name: "st_multilinestringfromtext", Fn: spatial.NewMLineFromText},
	...
	sql.Function1{Name: "st_numgeometries", Fn: spatial.NewNumGeometries},
	sql.Function1{Name: "st_numinteriorring", Fn: spatial.NewNumInteriorRings},
	sql.Function1{Name: "st_numinteriorrings", Fn: spatial.NewNumInteriorRings},
	sql.Function1{Name: "st_numpoints", Fn: spatial.NewNumPoints},
	sql.FunctionN{Name: "st_perimeter", Fn: spatial.NewPerimeter},
	sql.Function2{Name: "st_pointfromgeohash", Fn: spatial.NewPointFromGeoHash},
	sql.Function2{Name: "st_pointn", Fn: spatial.NewPointN},
	...
	sql.Function1{Name: "st_validate", Fn: spatial.NewValidate},
	...
	sql.Function1{Name: "std", Fn: func(ctx *sql.Context, e sql.Expression) sql.Expression { return aggregation.NewStdDevPop(e) }},
	sql.Function1{Name: "stddev", Fn: func(ctx *sql.Context, e sql.Expression) sql.Expression { return aggregation.NewStdDevPop(e) }},
	sql.Function1{Name: "stddev_pop", Fn: func(ctx *sql.Context, e sql.Expression) sql.Expression { return aggregation.NewStdDevPop(e) }},
	sql.Function1{Name: "stddev_samp", Fn: func(ctx *sql.Context, e sql.Expression) sql.Expression { return aggregation.NewStdDevSamp(e) }},
	...
	sql.Function1{Name: "variance", Fn: func(ctx *sql.Context, e sql.Expression) sql.Expression { return aggregation.NewVarPop(e) }},
	sql.Function1{Name: "var_pop", Fn: func(ctx *sql.Context, e sql.Expression) sql.Expression { return aggregation.NewVarPop(e) }},
	sql.Function1{Name: "var_samp", Fn: func(ctx *sql.Context, e sql.Expression) sql.Expression { return aggregation.NewVarSamp(e) }},
...
func GetLockingFuncs(ctx *sql.Context, ls *sql.LockSubsystem) []sql.Function {
	return []sql.Function{
		sql.Function2{Name: "get_lock", Fn: CreateNewGetLock(ctx, ls)},
